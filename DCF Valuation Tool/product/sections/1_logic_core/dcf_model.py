...
class DCFModel:
    def __init__(self, current_fcf, growth_rate, wacc, terminal_growth_rate, shares_outstanding, projection_years=5):
        """
    ...
    def calculate_intrinsic_value(self):
        ...
        equity_value = total_enterprise_value # Assuming no net debt for simplicity in this edu model
        price_per_share = equity_value / self.shares_outstanding
